# نظام LedgerX محاسبي وإداري

![لوحة التحكم](static/readme/dashboard.png)

نظام LedgerX مبني بـ `Flask` و `SQLite` لإدارة الدورة التشغيلية والمحاسبية اليومية داخل الشركات التجارية والصناعية، مع واجهة عربية مناسبة للعمل اليومي، ودورة مستندية مترابطة من الأوامر إلى الفواتير ثم القيود والتقارير.
