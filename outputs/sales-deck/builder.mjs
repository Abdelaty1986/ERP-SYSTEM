...
const DECK_ID = "erp-sales-deck";
const OUT_DIR = "C:\\Users\\Hany.Abdelatty\\Desktop\\تطوير برنامج ERP\\ملفات السيرفر 16-4-2027\\erp_dev_copy\\outputs\\sales-deck\\final";
const REF_DIR = "C:\\Users\\Hany.Abdelatty\\Desktop\\تطوير برنامج ERP\\ملفات السيرفر 16-4-2027\\erp_dev_copy\\outputs\\sales-deck\\references";
...
const MONO_FACE = "Segoe UI";

const FALLBACK_PLATE_DATA_URL =
  "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO+/p9sAAAAASUVORK5CYII=";

const SOURCES = {
  primary: "ERP Golden Demo - internal project build, QA report, README, and live screenshots from the current demo database.",
};

const SLIDES = [
  {
    "kicker": "ERP SALES DECK",
    "title": "نظام ERP محاسبي وإداري جاهز للعرض والتشغيل",
    "subtitle": "نسخة عملية تربط المبيعات والمشتريات والمخازن والحسابات داخل دورة تشغيل واضحة وسهلة الشرح.",
    "expectedVisual": "Dashboard-based cover with the product framed as a practical Arabic ERP for daily operations.",
    "moment": "نظام واحد يربط التشغيل والأثر المحاسبي والتقارير",
    "notes": "ابدأ بتأكيد أن النسخة المعروضة ليست Mockup بل ديمو فعلي ببيانات مترابطة وشاشات تعمل بالفعل.",
    "sources": [
      "primary"
    ]
  },
  {
    "kicker": "OVERVIEW",
    "title": "ما الذي يقدمه النظام للشركة؟",
    "subtitle": "النظام يغطي المستندات اليومية من أول الطلب وحتى أثرها في الأستاذ وميزان المراجعة.",
    "expectedVisual": "Sales screen as a practical example of a daily-use page with clear actions and visible document list.",
    "cards": [
      [
        "تشغيل يومي",
        "إدارة العملاء والموردين والأصناف والفواتير وسندات القبض والصرف من واجهة عربية منظمة."
      ],
      [
        "ترابط محاسبي",
        "كل حركة أساسية تنعكس على القيود ودفتر الأستاذ وميزان المراجعة والتقارير ذات الصلة."
      ],
      [
        "جاهزية عرض",
        "الديمو الحالي نظيف وواضح، وفيه سيناريو ذهبي قابل للشرح خطوة بخطوة أمام العميل."
      ]
    ],
    "notes": "اشرح هنا أن القيمة الحقيقية ليست في كثرة الشاشات فقط، بل في أن كل شاشة تؤدي دورًا واضحًا داخل الدورة.",
    "sources": [
      "primary"
    ]
  },
  {
    "kicker": "MODULES",
    "title": "الموديولات الأساسية في النسخة الحالية",
    "subtitle": "النسخة الحالية متوازنة بين التشغيل اليومي والرقابة المحاسبية بدون تعقيد زائد.",
    "expectedVisual": "Purchases screen as representative business module with visible summary cards and operational form.",
    "metrics": [
      [
        "المبيعات",
        "عملاء وفواتير",
        "أوامر بيع، فواتير بيع، مردودات"
      ],
      [
        "المشتريات",
        "موردون وفواتير",
        "أوامر شراء، فواتير مورد، مردودات"
      ],
      [
        "الحسابات",
        "قيود وتقارير",
        "يومية، أستاذ، ميزان مراجعة، تقارير"
      ]
    ],
    "notes": "يمكنك هنا ذكر أن المخازن والخزينة والإدارة وشؤون العاملين موجودة أيضًا وتدعم الصورة الكاملة للنظام.",
    "sources": [
      "primary"
    ]
  },
  {
    "kicker": "FLOW",
    "title": "دورة تشغيل واضحة من المستند إلى الحسابات",
    "subtitle": "الهدف ليس فقط تسجيل العملية، بل أن تسمع الشاشات في بعضها حتى تصل النتيجة إلى التقارير النهائية.",
    "expectedVisual": "Journal screen as proof that downstream accounting visibility exists after operational work.",
    "cards": [
      [
        "الشراء",
        "أمر شراء ثم إذن إضافة ثم تسجيل فاتورة المورد وفق السيناريو الصحيح دون تكرار الأثر المخزني."
      ],
      [
        "البيع",
        "أمر بيع ثم إذن صرف ثم إصدار فاتورة العميل مع ظهور أثرها في العميل والمخزون والحسابات."
      ],
      [
        "المراجعة",
        "النتائج تظهر في اليومية والأستاذ وكشوف الحساب وميزان المراجعة والتقارير التشغيلية."
      ]
    ],
    "notes": "هذه الشريحة مهمة جدًا أثناء البيع، لأنها توضح أن النظام لا يعرض بيانات معزولة بل دورة تشغيل مترابطة.",
    "sources": [
      "primary"
    ]
  },
  {
    "kicker": "CONTROL",
    "title": "قوة الرقابة والمتابعة المحاسبية",
    "subtitle": "المشروع لا يتوقف عند إصدار المستند، بل يمتد إلى الفلاتر وكشوف الحساب والطباعة والتقارير.",
    "expectedVisual": "Trial balance and accounting context with clear review-oriented framing.",
    "cards": [
      [
        "فلاتر عملية",
        "فلاتر في اليومية والأستاذ والعملاء والموردين والمخزون والتقارير لتسريع الوصول للمعلومة."
      ],
      [
        "طباعة جاهزة",
        "طباعة للمستندات الرئيسية مثل الفواتير وأوامر الشراء وسندات القبض والصرف والتسويات."
      ],
      [
        "اتزان محاسبي",
        "نسخة الديمو الحالية متزنة في ميزان المراجعة وتمت مراجعة مساراتها الأساسية باختبارات QA."
      ]
    ],
    "notes": "يمكنك استخدام هذه الشريحة لطمأنة العميل أن النظام يصلح للتشغيل اليومي والمراجعة، وليس فقط للإدخال.",
    "sources": [
      "primary"
    ]
  },
  {
    "kicker": "STATUS",
    "title": "حالة النسخة الحالية ولماذا هي جاهزة للعرض",
    "subtitle": "تم تجهيز نسخة ديمو نظيفة مع مراجعة تشغيلية حديثة، ما يجعل العرض على العميل مباشرًا وواضحًا.",
    "expectedVisual": "Dashboard or trial-balance backed closing slide with confidence-oriented summary metrics.",
    "metrics": [
      [
        "87",
        "حسابًا في الدليل",
        "تم الحفاظ على شجرة الحسابات"
      ],
      [
        "18",
        "قيدًا في الديمو",
        "مع أستاذ وميزان مراجعة متزن"
      ],
      [
        "200",
        "نجاح المسارات الرئيسية",
        "آخر QA على الشاشات الأساسية والطباعة"
      ]
    ],
    "notes": "اختم بالتأكيد أن النسخة جاهزة للعرض الآن، وأن التطوير القادم يكون حسب قطاع العميل أو مرحلة التسليم التجاري.",
    "sources": [
      "primary"
    ]
  }
...
async function slideCards(presentation, idx) {
  ...
  for (let cardIdx = 0; cardIdx < cols; cardIdx += 1) {
    ...
    addCard(slide, idx, x, 408, cardW, 204, label, body, { iconKind: iconKinds[cardIdx % iconKinds.length] });
  }
